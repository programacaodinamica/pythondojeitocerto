...
if __name__ == '__main__':
    ...
    # print(f"A soma das fracoes {fracao1} e {fracao2} é", 
    #       fracao1 + fracao2)
    
    # print(f"A diferença das fracoes {fracao1} e {fracao2} é", 
    #       fracao1 - fracao2)
    
    # print(f"O produto das fracoes {fracao1} e {fracao2} é", 
    #       fracao1 * fracao2)
    
    # print(f"{fracao1} dividido por {fracao2} é", 
    #       fracao1 / fracao2)
    
    # print(f"A fração {fracao1} é menor que {fracao2}?", 
    #       fracao1 < fracao2)
    
    # print(f"A fração {fracao1} é maior que {fracao2}?", 
    #       fracao1 > fracao2)
    
    # print(f"A fração {fracao1} é igual a {fracao2}?", 
    #       fracao1 == fracao2)
    
    # print(f"A fração {fracao1} é menor ou igual a {fracao2}?", 
    #       fracao1 <= fracao2)
    
    # print(f"A fração {fracao1} é maior ou igual a {fracao2}?", 
    #       fracao1 >= fracao2)
